...
// The sort is stable, meaning that elements with the same sort key maintain their
// relative order from the original collection. This function creates a new slice
...
// This function provides more control than SortBy by allowing you to specify
// whether to sort in ascending or descending order. The sort is stable, meaning
// that elements with the same sort key maintain their relative order from the
// original collection. This function creates a new slice and does not modify
...
// This function is useful for performing side effects on each element of a map without
// creating a new collection. The order of iteration is not guaranteed due to the
// nature of Go maps.
//
// Parameters:
...
// Unlike ForEachMap, this function returns a new slice containing the results of
// applying the iteratee function to each element. The order of elements in the
// resulting slice is not guaranteed due to the nature of Go maps.
//
// Parameters:
//   - collection: The map to process
...
// This function creates a new map containing only the key-value pairs for which
// the predicate function returns true. The original map is not modified.
//
// Parameters:
//   - collection: The map to process
//   - predicate: The function that returns true for elements to include
...
// This function iterates over each key-value pair in the map and applies the iteratee
// function to accumulate a single result. The order of iteration is not guaranteed
// due to the nature of Go maps.
//
// Parameters:
//   - collection: The map to process
